...
export class Rectangle {
    ...
    public intersectsRectangle(rectangle: Rectangle): boolean {
        return MathHelper.intersectsRectangleRectangle(rectangle, this);
    }
    ...
    public static fromRawValues(x: number, y: number, width: number, height: number) {
        return new Rectangle(new Vector2(x, y), new Vector2(width, height));
    }
}
