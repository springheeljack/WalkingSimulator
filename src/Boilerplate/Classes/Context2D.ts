...
declare global {
    interface CanvasRenderingContext2D {
        ...
        drawTransformString(text: string, position: Vector2, size: number, font: Fonts, colour: Colour, align: Align): void;
        ...
        drawTextureRectangle(texture: Texture, rectangle: Rectangle, rotation?: number, origin?: Vector2): void;
...
CanvasRenderingContext2D.prototype.drawTransformString = function (text: string, position: Vector2, size: number, font: Fonts, colour: Colour, align: Align) {
    this.fillStyle = colour.getHexString();
    this.setFont(font, size);
    this.setAlign(align);
    this.fillText(text, position.x, position.y);
...
CanvasRenderingContext2D.prototype.drawTextureRectangle = function (texture: Texture, rectangle: Rectangle, rotation?: number, origin?: Vector2) {
    if (rotation == null) {
